            ...
            <tr>
                <td id="content">
                    ...
                    <?php else: ?>
                        ...
                        <h2>Time and Again Bookstore: Inventory Management</h2>
                        <div class="warning"><strong>Notice:</strong> This is a private website. If you are not
                            authorized to use this website, please leave this page immediately.</div>
